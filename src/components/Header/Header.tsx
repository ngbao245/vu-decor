...
const Header = () => {
  return (
    <section className="flex justify-center py-4 lg:py-8 items-center bgColor shadow-md">
      <div
        className="container max-w-6xl mx-auto px-4 "
      >
        <div className="grid grid-cols-2 lg:grid-cols-4 border border-white/15  py-2 px-4 md:pr-2 items-center">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button variant="primary" className="hidden md:inline-flex items-center">Sign In</Button> */}
