    ...
    return (
        <section ref={ref} className='w-full h-max flex flex-col gap-5 md:gap-8'>
            ...
            >
                ...
                <h5 className='text-sm md:text-base hidden lg:flex'>Không gian sống lý tưởng chính là nơi nuôi dưỡng cảm hứng và
                    khơi gợi sự hứng khởi mỗi sớm mai thức giấc. <br className="md:block" /> Với niềm đam mê kiến tạo, chúng tôi
